...
class App:
    ...
    def edit_win(self):
        ...
        cbx = ttk.Combobox(win, textvariable=var, values=names, state="readonly", width=55)
        cbx.pack()
    ...
    def del_win(self):
        ...
        names = list(self.tools.keys())
        var = tk.StringVar(value=names[0])
        ttk.Combobox(win, textvariable=var, values=names, state="readonly", width=45).pack(pady=10)
