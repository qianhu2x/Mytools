...
class App:
    ...
    def edit_win(self):
        ...
        cbx = ttk.Combobox(win, textvariable=var, values=names, state="readonly", width=85)
        cbx.pack()
    ...
    def del_win(self):
        ...
        ttk.Button(win, text="确认删除", command=do).pack()
